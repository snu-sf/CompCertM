...
Module Info.
  ...
  Definition source_file := "a.c"%string.
...
(Ssequence
  ...
  (Ssequence
    (Scall (Some _t'1)
      (Evar _f (Tfunction (Tcons tint Tnil) tint cc_default))
...
((___builtin_ais_annot,
 ...
 (_f,
   Gfun(External (EF_external "f"
                   (mksignature (AST.Tint :: nil) (Some AST.Tint) cc_default))
     (Tcons tint Tnil) tint cc_default)) :: (_g, Gfun(Internal f_g)) :: nil).

Definition public_idents : list ident :=
(_g :: _f :: ___builtin_debug :: ___builtin_nop ::
