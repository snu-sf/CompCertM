...
Hypothesis strong_wf_tgt_spec: forall
    se ge st0 st1 tr0
...
.
Hypothesis wf_tgt_strengthen: forall
    se ge st0 tr st1
...
Let strong_wf_tgt_spec_starN: forall
    se ge n st0 st1 tr0 tr1 st2
...
Proof.
  ii.
  exploit strong_wf_tgt_spec; eauto. intro P.
  destruct n; ss.
...
.
Proof.
  apply starN_plus_iff in PLUS. des. apply lift_starN in PLUS; et. des. esplits; et.
