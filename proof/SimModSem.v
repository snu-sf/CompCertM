...
Section SIMMODSEM.
  ...
  Context `{OHEQSRC: LeibEq ms_src.(owned_heap) SimMemOh.owned_heap_src}.
  Context `{OHEQTGT: LeibEq ms_tgt.(owned_heap) SimMemOh.owned_heap_tgt}.
  ...
  | lxsim_at_external
      ...
      <<CALLFSIM: forall oh_src0 args_src
          ...
          exists oh_tgt0 args_tgt (smo_arg: SimMemOh.t),
            (<<SIMARGS: SimMemOh.sim_args (cast oh_src0) oh_tgt0 args_src args_tgt smo_arg>>
            /\ (<<MWF: SimMemOh.wf smo_arg>>)
            /\ (<<MLE: SimMemOh.lepriv smo0 smo_arg>>)
            /\ (<<ATTGT: ms_tgt.(at_external) st_tgt0 (cast oh_tgt0) args_tgt>>)
            /\ (<<K: forall smo_ret oh_src1 retv_src oh_tgt1 retv_tgt st_src1
                ...
                (AFTERSRC: ms_src.(after_external) st_src0 (cast oh_src1) retv_src st_src1),
                exists st_tgt1 smo_after i1,
                  (<<AFTERTGT: ms_tgt.(after_external) st_tgt0 (cast oh_tgt0) retv_tgt st_tgt1>>) /\
  ...
  | lxsim_final
      ...
      (SIMRETV: SimMemOh.sim_retv (cast oh_src) (cast oh_tgt) retv_src retv_tgt smo_ret).
...
Context {SM: SimMem.class} {SS: SimSymb.class SM} {SU: Sound.class} {SMO: @SimMemOh.class SM}.
  ...
  | sim_intro
      ...
      (OHEQSRC: LeibEq msp.(src).(owned_heap) SimMemOh.owned_heap_src)
      (OHEQTGT: LeibEq msp.(tgt).(owned_heap) SimMemOh.owned_heap_tgt)
      ...
      (SIM: forall
          ...
          (<<INITBSIM: forall st_init_tgt
              (INITTGT: msp.(tgt).(initial_frame) (cast oh_tgt) args_tgt st_init_tgt)
              (SAFESRC: exists _st_init_src, msp.(src).(initial_frame) (cast oh_src) args_src _st_init_src),
              exists st_init_src sm_init idx_init,
                (<<MLE: SimMemOh.le sm_arg sm_init>>) /\
                (<<INITSRC: msp.(src).(initial_frame) (cast oh_src) args_src st_init_src>>) /\
          ...
          (<<INITPROGRESS: forall
              (SAFESRC: exists st_init_src, msp.(src).(initial_frame) (cast oh_src) args_src st_init_src),
              exists st_init_tgt, (<<INITTGT: msp.(tgt).(initial_frame) (cast oh_tgt) args_tgt st_init_tgt>>)>>)).
