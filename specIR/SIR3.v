...
Section MODSEM.
  ...
  Inductive get_k (st0: state): (val -> itree eff3 val) -> Prop :=
  | get_k_intro
      _vs _fptr k
  ...
  | after_external_intro
      ...
      (V: (Retv.v retv) = rv)
      (M: (Retv.m retv) = m0)
      (KONT: st1 = mk (k rv) st0.(le) oh0 m0)
    :
  ...
  | step_tau
      ...
      (ST0: st0 = mk itr0 le0 oh0 m0)
      (TR: tr = E0)
      (ST1: st1 = mk itr1 le0 oh0 m0)
  ...
  | step_ohput
      ...
      (ST0: st0 = mk itr0 le0 oh0 m0)
      (TR: tr = E0)
      (ST1: st1 = mk (k tt) le0 oh1 m0)
  | step_lget
      itr0 (hd0: ident -> option val) (tl0: lenv) oh0 m0
      k x v
      (VIS: (observe st0) = VisF (subevent _ (LGet x)) k)
      (GET: hd0 x = Some v)

      (ST0: st0 = mk itr0 (hd0 :: tl0) oh0 m0)
      (TR: tr = E0)
      (ST1: st1 = mk (k v) (hd0 :: tl0) oh0 m0)
  | step_lput
      itr0 (hd0: ident -> option val) (tl0: lenv) oh0 m0
      x v k
      (VIS: (observe st0) = VisF (subevent _ (LPut x v)) k)

      (ST0: st0 = mk itr0 (hd0 :: tl0) oh0 m0)
      (TR: tr = E0)
      (ST1: st1 = mk (k tt) (Maps.add x v hd0 :: tl0) oh0 m0)
  | step_lpush
      itr0 le0 oh0 m0
      k
      (VIS: (observe st0) = VisF (subevent _ (LPush)) k)

      (ST0: st0 = mk itr0 le0 oh0 m0)
      (TR: tr = E0)
      (ST1: st1 = mk (k tt) (Maps.empty :: le0) oh0 m0)
  | step_lpop
      itr0 (hd0: ident -> option val) (tl0: lenv) oh0 m0
      k
      (VIS: (observe st0) = VisF (subevent _ (LPop)) k)

      (ST0: st0 = mk itr0 (hd0 :: tl0) oh0 m0)
      (TR: tr = E0)
      (ST1: st1 = mk (k tt) (tl0) oh0 m0)
  .
